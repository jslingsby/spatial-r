...
Afternoons are self-study time where you will incrementally develop your own individual GIS project in R and [RMarkdown](https://rmarkdown.rstudio.com/) or [Quarto](https://quarto.org/). The project will count 70% of your mark for the module and will be **due on Friday the 1st March**. You will need to submit a .Rmd or .Qmd file and stitched HTML notebook. You're welcome to do this in a Git Repository (nudge nudge), now that we've completed the [Reproducible Research](https://www.ecologi.st/data-management/) module.
