...
I've included quite a bit of demonstration R code in Chapter \@ref(rdemo). To run the code you will need:
...
Afternoons are self-study time where you will incrementally develop your own individual GIS project in R and [RMarkdown](https://rmarkdown.rstudio.com/) or [Quarto](https://quarto.org/). The project will count 70% of your mark for the module and will be **due on Thursday the 16th March**. You will need to submit a .Rmd or .Qmd file and stitched HTML notebook. You're welcome to do this in a Git Repository (nudge nudge), now that we've completed the [Data Management module](https://www.ecologi.st/data-management/).
...
I will be available 2-3PM on Wednesday afternoon as a "help desk" to assist you refine your projects and help troubleshoot issues.
