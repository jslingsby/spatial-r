...
```{r googlemap, echo=FALSE, fig.cap = "Screenshot of Google Mas for Cape Town.", fig.width=4, fig.align = 'center'}
...
```{r biomes, echo=FALSE, fig.cap = "We use it for things like mapping ecosystems and biomes.", fig.width=3, fig.align = 'center'}
knitr::include_graphics("img/biomes.png")
```

<br>

```{r biomeremnants, echo=FALSE, fig.cap = "Or the loss of ecosystems and biomes.", fig.width=3, fig.align = 'center'}
knitr::include_graphics("img/biome_remnants.png")
```

<br>

```{r biomeloss, echo=FALSE, fig.cap = "Although the outcomes of GIS analyses are not always maps, e.g. [@Skowno2021].", fig.width=3, fig.align = 'center'}
knitr::include_graphics("img/skowno2021.png")
```

<br>

```{r globalforestwatch, echo=FALSE, fig.cap = "But it can also be interactive!", fig.width=3, fig.align = 'center'}
