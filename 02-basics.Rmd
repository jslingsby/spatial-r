...
```{r rle2, echo=FALSE, fig.cap = "A simplified workflow for assessing threat to South Africa's ecosystems, highlighting GIS opetarions in italics...", out.width='100%', fig.align = 'center'}
